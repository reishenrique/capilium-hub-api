...
import { UserResponseDto, UserResponseDtoSwagger } from '../dto/responseUserDto';
...
export class UserController {
		...
		@ApiResponse({ status: 201, type: UserResponseDtoSwagger })
		@ApiResponse({
			status: 409,
		...
		@ApiResponse({ status: 200, type: UserResponseDtoSwagger })
